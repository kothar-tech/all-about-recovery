...
const pillars = ["Community connection", "Inclusive environment", "Choice-centred approach"];

export function Hero() {
  return (
    <section className="relative overflow-hidden bg-cream pt-6 md:pt-10" aria-labelledby="hero-heading">
      <Container>
        ...
        <Reveal>
          <p className="max-w-xl text-[0.9375rem] leading-relaxed text-bark/75 md:text-base">
            We help our participants move from vulnerability to confidence so they
          ...
          <div className="lg:col-span-7">
            <Reveal delay={80}>
              <h1 id="hero-heading" className="text-display text-bark">
                ...
                <span className="relative inline-block">
                  <span className="relative z-10">psychosocial</span>
                  <span
                    aria-hidden
                    className="absolute inset-x-[-0.05em] bottom-[0.17em] z-0 h-[0.22em] rounded-full bg-sage-light/75"
                  />
                </span>{" "}
                disabilities
              </h1>
            ...
            <Reveal delay={160}>
              <p className="text-lead mt-8 max-w-xl text-bark/75">
                A registered NDIS provider working alongside people navigating mental
            ...
            <Reveal delay={220}>
              <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <Button href="/services" size="lg" withArrow>Explore our services</Button>
                <Button href="/referrals" variant="ghost" size="lg">Make a referral</Button>
              </div>
            </Reveal>
            ...
            <Reveal delay={280}>
              <ul className="mt-10 flex flex-wrap gap-x-6 gap-y-3">
                {pillars.map((p) => (
                  <li key={p} className="flex items-center gap-2.5 text-[0.9375rem] font-medium text-bark/75">
            ...
            <Reveal delay={200}>
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-4 rounded-lg bg-sage-light px-6 py-5 text-bark shadow-[0_18px_40px_-20px_rgba(84,51,50,0.55)] sm:-left-6">
                  <p className="text-3xl font-semibold leading-none text-bark-deep">3</p>
                  <p className="mt-1.5 text-[0.8125rem] leading-snug text-bark">
                    NSW regions<br />Sydney · Dubbo · Tamworth
                  </p>
                </div>
              </div>
            </Reveal>
